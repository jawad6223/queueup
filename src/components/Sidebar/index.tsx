                            ...
                            {sidebarMenu.menuItems.map((item) => {
                                ...
                                return (
                                    <li key={item.id}>
                                        <Link
                                            href={item.link || ""}
                                            className={`flex items-center relative overflow-visible w-fit gap-3 p-2 font-medium text-black-500 text-[18px] capitalize hover:text-[#EF4444] ${isActive ? "text-[#EF4444]" : "text-white"
